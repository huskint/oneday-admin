...
export const requestGet = ({
  url,
  headers,
}: { url: string; headers?: any }) => client.get(url, {
  headers: {
    ...headers,
  },
});
...
export const requestPost = ({
  ...
  headers,
  data,
}: { url: string; headers?: any, data: any }) => client.post(url, data, {
  headers: {
    ...headers,
  },
});
...
export const requestPut = ({
  url,
  headers,
}: { url: string; headers?: any }) => client.put(url, {
  headers: {
    ...headers,
  },
});
...
export const requestPatch = ({
  url,
  headers,
}: { url: string; headers?: any }) => client.patch(url, {
  headers: {
    ...headers,
  },
});
...
export const requestDelete = ({
  url,
  headers,
}: { url: string; headers?: any }) => client.delete(url, {
  headers: {
    ...headers,
  },
});
